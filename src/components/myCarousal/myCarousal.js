    ...
    <div id="home">
      <Carousel  controls={false} indicators interval={3500} pause={false}>
        ...
        <Carousel.Item>
          ...
          <div className="carousel-caption  quote">
            <h3 className="arabic">"الجمال في كل مكان، فقد علينا النظر"</h3>
            <h3 className="english">"The beauty is everywhere, we just need to look"</h3>
          </div>
        </Carousel.Item>
        <Carousel.Item>
          <img className="d-block w-100 custom-img" src="https://images.unsplash.com/photo-1521388825798-fec41108def2?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1160&q=80" alt="Third slide" />
          <div className="carousel-caption  quote">
          <h3 className="arabic">"إذا كانت لديك القدرة لتُحب، حب نفسك أولاً"</h3>
            <h3 className="english">"If you have the ability to love, love yourself first"</h3>
         </div>
        </Carousel.Item>
        <Carousel.Item>
          <img className="d-block w-100 custom-img" src="https://images.unsplash.com/photo-1514946379532-90281f815889?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1500&q=80" alt="Third slide" />
          <div className="carousel-caption  quote">
          <h3 className="arabic">"رَغبتُك في التَغيير يجب أن تفوق رغبتك في البقاء البقاء كما أنت"</h3>
            <h3 className="english">"Your desire to change most outweigh your desire to stay as you are"</h3>
          </div>
        </Carousel.Item>
